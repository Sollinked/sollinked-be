...
import { ContentProductId, fillableColumns } from "../Models/contentProductId";

const table = 'content_product_ids';
...
export const view = async(id: number) => {
    ...
    const result = await DB.executeQueryForSingleResult<ContentProductId>(query);
...
export const find = async(whereParams: {[key: string]: any}) => {
    ...
    const result = await DB.executeQueryForResults<ContentProductId>(query);
